...
export const DEFAULT_VALUE_MAPPINGS: ValueMapping[] = [
  ...
  { field: "kitchen", rawValue: "Ja, in meiner Küche geht`s", mappedValue: "kann_gekocht_werden", isDefault: true },
  { field: "kitchen", rawValue: "Mein/e Kochpartner/in hat eine Küche", mappedValue: "partner_kocht", isDefault: true },
  { field: "kitchen", rawValue: "Nein, ich brauche eine/n Kochpartner/in mit Küche", mappedValue: "kann_nicht_gekocht_werden", isDefault: true },
